...
<div class="page-breadcrumb bg-white">
    <div class="row align-items-center">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">{{ __('Edit Student Diary') }}</h4>
        </div>
                ...
                <section class="wrapper" style="margin-top: 30px;">
                     ...
                     <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                               <x-alert />
                                <form class="form-horizontal form-material" action="{{ route('student-diary.update',$diary->id) }}" method="post">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <select name='student_id' class="form-select shadow-none p-0 border-0 form-control-line" style="background-image: none;">
                                                ...
                                                @foreach (App\Models\Student::get() as $student)
                                                    <option @if(old('student_id',$diary->student_id) == $student->id) selected @endif value="{{ $student->id }}">{{ $student->first_name." ".$student->last_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
