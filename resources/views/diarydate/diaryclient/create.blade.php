...
<div class="page-breadcrumb bg-white">
    <div class="row align-items-center">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <div class="d-md-flex">
                <a href="{{ route('client-diary.index') }}"
                ...
                <section class="wrapper" style="margin-top: 30px;">
                     ...
                     <div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                               <x-alert />
                                <form class="form-horizontal form-material" action="{{ route('client-diary.store') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="statment" value="{{ old('statment') }}" id="statment" class="form-control p-0 border-0">
