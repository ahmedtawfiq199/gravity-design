        ...
        <div class="col-md-12">
            ...
            <div class="white-box">
                ...
                <section class="wrapper" style="margin-top: 30px;">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header"><i class="fa fa-laptop"></i> {{ __('Trashed Students') }}</h3>
                        </div>
                    </div>
                    <div>
                        <x-alert />
                ...
                <div class="modal fade" id="modals-restore-trashed-student{{ $student->id }}">
                    <div class="modal-dialog">
                        <form class="create-new-nature modal-content pt-0"
                              action="{{ route('students.restore',$student->id) }}" method="POST">
                            @csrf
                            <div class="modal-header mb-1">
                                <h5 class="modal-title" id="exampleModalLabel">ارجاع الطالب</h5>
                            </div>
                            <div class="modal-body flex-grow-1">

                                <div class="form-group">
                                    <label for="username">{{__('هل تريد ارجاع هذه الطالب')}}</label>
                                </div>
...

                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return (
                                    ...
                                    '<a href="#" class="dropdown-item delete-record" data-toggle= "modal" data-target= "#modals-restore-trashed-student' +
                                    id + '">' +
                                    feather.icons['corner-down-left'].toSvg({
